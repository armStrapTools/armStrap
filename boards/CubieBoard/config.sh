BOARD_ARCH="arm"
BOARD_ARCH_EABI="hf"
BOARD_ARCH_TYPE="linux-gnueabi"
BOARD_ARCH_COMPILER="${BOARD_ARCH}-${BOARD_ARCH_TYPE}${BOARD_ARCH_EABI}"
BOARD_ARCH_PREFIX="${BOARD_ARCH_COMPILER}-"
BOARD_ARCH_GCC_VERSION="4.7"
BOARD_ARCH_GCC_PACKAGE="gcc-${BOARD_ARCH_GCC_VERSION}-${BOARD_ARCH_COMPILER}"
...
BOARD_MNT_ROOT="${BOARD_ROOT}/mnt"
BUILD_MNT_BOOT="${BOARD_MNT_ROOT}/boot"
...
BUILD_CONFIG_CMDLINE="console=tty0 console=${BUILD_SERIALCON_TERM},${BUILD_SERIALCON_SPEED} hdmi.audio=EDID:0 disp.screen0_output_mode=EDID:1280x720p60 root=${BOARD_ROOT_DEV} rootwait panic=10"
...
BUILD_KERNEL_SRCDST="${BOARD_MNT_ROOT}/usr/src"

BUILD_UBOOT_GIT="https://github.com/linux-sunxi/u-boot-sunxi.git"
BUILD_UBOOT_DIR="${BOARD_SRC}/u-boot-sunxi"
BUILD_UBOOT_SRCDST="${BOARD_MNT_ROOT}/usr/src"

BUILD_SUNXI_BOARD_GIT="https://github.com/linux-sunxi/sunxi-boards.git"
BOARD_SUNXI_BOARD_DIR="${BOARD_SRC}/sunxi-boards"
BUILD_SUNXI_BOARD_SRCDST="${BOARD_MNT_ROOT}/usr/src"

BUILD_SUNXI_TOOLS_GIT="https://github.com/linux-sunxi/sunxi-tools.git"
BOARD_SUNXI_TOOLS_DIR="${BOARD_SRC}/sunxi-tools"
BUILD_SUNXI_TOOLS_SRCDST="${BOARD_MNT_ROOT}/usr/src"

BUILD_BOOT_CMD="${BOARD_MNT_ROOT}/boot/boot.cmd"
BUILD_BOOT_SCR="${BOARD_MNT_ROOT}/boot/boot.scr"

BUILD_BOOT_FEX="${BOARD_MNT_ROOT}/boot/cubieboard.fex"
BUILD_BOOT_BIN="${BOARD_MNT_ROOT}/boot/script.bin"
...
BOARD_PREREQ="build-essential u-boot-tools qemu qemu-user-static debootstrap parted kpartx lvm2 git binfmt-support libusb-1.0-0-dev pkg-config dosfstools binfmt-support libncurses5-dev"
