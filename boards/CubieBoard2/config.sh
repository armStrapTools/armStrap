...
BUILD_KERNEL_GIT="https://github.com/jwrdegoede/linux-sunxi.git"
BUILD_KERNEL_GIT_BRANCH="sunxi-3.3-cubieboard2"
if [ -z "${BUILD_KERNEL_GIT_BRANCH}" ]; then
  BUILD_KERNEL_GIT_PARAM=""
  BUILD_KERNEL_DIR="${ARMSTRAP_SRC}/linux-sunxi_jwrdegoede/head"
else
  BUILD_KERNEL_GIT_PARAM="-b ${BUILD_KERNEL_GIT_BRANCH}"
  BUILD_KERNEL_DIR="${ARMSTRAP_SRC}/linux-sunxi_jwrdegoede/${BUILD_KERNEL_GIT_BRANCH}"
fi
...
if [ -z "${BUILD_UBOOT_GIT_BRANCH}" ]; then
  ...
  BUILD_UBOOT_GIT_PARAM="-b ${BUILD_UBOOT_GIT_BRANCH}"
