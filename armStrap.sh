...
ARMSTRAP_ROOTFS="${ARMSTRAP_ROOT}/builder/root"
...
ARMSTRAP_ABUILDER_ROOTFS="${ARMSTRAP_ABUILDER_ROOT}/root"
ARMSTRAP_ABUILDER_ROOTFS_URL="${ARMSTRAP_ABUILDER_URL}/root"
...
ARMSTRAP_ABUILDER_REPO="/var/www/armstrap.net/apt"
ARMSTRAP_ABUILDER_REPO_URL="${ARMSTRAP_ABUILDER_URL}/apt"
